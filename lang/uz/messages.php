...
return [
    ...
    ":amount Total" => ":Amount Jami",
    ":days day trial" => ":Days day trial",
    ":resource Details" => ":Resource Tafsilotlarini",
    ":resource Details: :title" => ":Resource Tafsilotlarini: :title",
    ":trialDays Day Trial" => ":TrialDays Day Trial",
    "A fresh verification link has been sent to your email address." => "A fresh verification link has been sent to your email address.",
    "A new verification link has been sent to the email address you provided during registration." => "Ro'yxatga olish paytida taqdim etilgan elektron pochta manziliga yangi tekshirish havolasi yuborildi.",
    ...
    "Action Happened At" => "Da Sodir",
    "Action Initiated By" => "Tashabbusi Bilan",
    "Action Name" => "Nomlash",
    "Action Status" => "Statuslari",
    "Action Target" => "Nishonov Maqsud",
    "Actions" => "Amallari",
    "Add" => "Qo'shish",
    ...
    "Alabama" => "Alabama",
    "Aland Islands" => "Åland Orollar",
    "Alaska" => "Alaska",
    "Albania" => "Albaniya",
    "Alberta" => "Alberta",
    "Algeria" => "Algeria degan",
    "All of the people that are part of this team." => "Bu jamoa tarkibiga kiruvchi barcha odamlar.",
    "All resources loaded." => "Barcha manbalar Yuklangan.",
    ...
    "Another user has updated this resource since this page was loaded. Please refresh the page and try again." => "Ushbu sahifa yuklanganidan beri boshqa foydalanuvchi ushbu manbani yangiladi. Iltimos, sahifani yangilang va qayta urinib ko'ring.",
    ...
    "Are you sure you want to delete the selected resources?" => "Agar tanlangan resurslarni o'chirish uchun ishonchingiz komilmi?",
    "Are you sure you want to delete this announcement?" => "Are you sure you want to delete this announcement?",
    "Are you sure you want to delete this file?" => "Agar bu faylni o'chirish uchun ishonchingiz komilmi?",
    ...
    "Are you sure you want to delete this resource?" => "Agar bu resurs o'chirish uchun ishonchingiz komilmi?",
    ...
    "Are you sure you want to detach the selected resources?" => "Agar tanlangan resurslarni ajratib olmoqchi ishonchingiz komilmi?",
    "Are you sure you want to detach this resource?" => "Ushbu resursni ajratib olishni xohlaysizmi?",
    "Are you sure you want to force delete the selected resources?" => "Agar tanlangan resurslarni o'chirish majbur ishonchingiz komilmi?",
    "Are you sure you want to force delete this resource?" => "Agar bu resurs o'chirish majbur qilish ishonchingiz komilmi?",
    "Are you sure you want to log out?" => "Are you sure you want to log out?",
    "Are you sure you want to remove this item?" => "Are you sure you want to remove this item?",
    "Are you sure you want to restore the selected resources?" => "Tanlangan resurslarni qayta tiklashni xohlaysizmi?",
    "Are you sure you want to restore this resource?" => "Ushbu resursni qayta tiklashni xohlaysizmi?",
    "Are you sure you want to resume your subscription?" => "Are you sure you want to resume your subscription?",
    "Are you sure you want to run this action?" => "Agar bu harakatni ishlatish uchun ishonchingiz komilmi?",
    ...
    "Attach" => "Biriktiring",
    "Attach & Attach Another" => "Attach & Boshqa Biriktiring",
    "Attach :resource" => "Qo'shishingiz :resource",
    ...
    "Bonaire, Sint Eustatius and Saba" => "Bonaire, Sint Eustatius va Sábado",
    "Bosnia And Herzegovina" => "Bosniya va Gersegovina",
    "Bosnia and Herzegovina" => "Bosnia and Herzegovina",
    "Botswana" => "Botswana",
    "Bouvet Island" => "Bouvet Orol",
    "Brazil" => "Braziliya",
    ...
    "Cape Verde" => "Kabo-Berdi",
    "Card" => "Kart-Saisiyat",
    "Cardholder's Name" => "Cardholder's Name",
    "Cayman Islands" => "Cayman Orollar",
    ...
    "China" => "Xitoy",
    "Choose" => "Tanlash",
    "Choose :field" => ":Field tanlash",
    "Choose :resource" => ":Resource tanlash",
    "Choose a project" => "Choose a project",
    "Choose an option" => "Variantni tanlang",
    "Choose date" => "Sana tanlang",
    "Choose File" => "Faylni Tanlang",
    "Choose Files" => "Choose Files",
    "Choose Type" => "Turini Tanlang",
    "Christmas Island" => "Rojdestvo Orol",
    "City" => "City",
    ...
    "Close" => "Yaqin",
    "Cocos (Keeling) Islands" => "Cocos () Keeling Orollar",
    "Code" => "Kodilar",
    "Colombia" => "Kolumbiya",
    "Colorado" => "Colorado",
    "Comoros" => "Comoros",
    ...
    "Confirm your :amount payment" => ":Amount siz to'lovni tasdiqlang",
    "Congo" => "Congo",
    "Congo, Democratic Republic" => "Kongo, Demokratik Respublikasi",
    ...
    "Create" => "Yaratish",
    "Create & Add Another" => "Yaratish & Boshqa Qo'shish",
    ...
    "Delete Resource" => "Resurs O'chirish",
    "Delete Selected" => "Tanlangan O'chirish",
    "Delete Team" => "Jamoani O'chirish",
    "Delete Token" => "Delete Token",
    "Deleting" => "Deleting",
    "Denmark" => "Daniya",
    "Detach" => "Detach",
    "Detach Resource" => "Detach Resurs",
    "Detach Selected" => "Detach Tanlangan",
    "Details" => "Batafsil",
    "Developer" => "Developer",
    "Disable" => "O'chirish",
    ...
    "Djibouti" => "Jibuti",
    "Do you really want to leave? You have unsaved changes." => "Agar chindan tark istaysizmi? Siz saqlanmagan o'zgarishlar bor.",
    "Dominica" => "Yakshanbalik",
    "Dominican Republic" => "Dominican Respublikasi",
    "Done." => "Qilingan.",
    ...
    "Ecuador" => "Ekvadorda",
    "Edit" => "Edit. uz",
    "Edit :resource" => "Tahrir :resource",
    "Edit Attached" => "Tahrirlash Biriktirilgan",
    ...
    "Equatorial Guinea" => "Equatorial Gvineya",
    "Eritrea" => "Eritreya",
    "Error" => "Error",
    "Estonia" => "Estoniya",
    "Ethiopia" => "Ethiopia",
    ...
    "Extra confirmation is needed to process your payment. Please continue to the payment page by clicking on the button below." => "Qo'shimcha tasdiqlash to'lov qayta ishlash uchun zarur bo'lgan. Quyidagi tugmani bosish orqali to'lov sahifasiga davom iltimos.",
    "Failed to load :resource!" => "Failed to load :resource!",
    "Falkland Islands (Malvinas)" => "Falkland Orollari (Malvinas)",
    ...
    "Force Delete" => "Kuch O'chirish",
    "Force Delete Resource" => "Kuch O'chirish Resurs",
    "Force Delete Selected" => "Force Tanlangan O'chirish",
    "Forever" => "Forever",
    ...
    "Hawaii" => "Hawaii",
    "Heard Island & Mcdonald Islands" => "Heard Island va McDonald orollari",
    "Heard Island and McDonald Islands" => "Heard Island and McDonald Islands",
    "Hello!" => "Salomlashamiz!",
    "Here is your new API token." => "Here is your new API token.",
    "Hi :name" => "Hi :name",
    "Hi!" => "Hi!",
    "Hide Content" => "Tarkibni Yashirish",
    "Hold Up!" => "Ushlab Turing!",
    "Holy See (Vatican City State)" => "Vatican City",
    "Honduras" => "Tarjima gonduras",
    "Hong Kong" => "Hong Kong",
    "Hungary" => "Vengriya",
    ...
    "Invoices" => "Invoices",
    "Iowa" => "Iowa",
    "Iran, Islamic Republic Of" => "Eron",
    "Iran, Islamic Republic of" => "Iran, Islamic Republic of",
    "Iraq" => "Iraqiyat",
    "Ireland" => "Irlandiya",
    "Isle Of Man" => "Inson ishle",
    ...
    "Korea, Democratic People's Republic of" => "Shimoliy Koreya",
    ...
    "Light" => "Light",
    "Lithuania" => "Litva",
    "Load :perPage More" => "Batafsil yuk :perPage",
    "Loading" => "Loading",
    ...
    "Niue" => "Niue",
    "No" => "Nashkiev. nu",
    "No :resource matched the given criteria." => "Yo'q :resource berilgan mezonlarga mos.",
    "No additional information..." => "Hech qanday qo'shimcha ma'lumot...",
    "No Current Data" => "Hozirgi Ma'lumotlar Yo'q",
    "No customer support request recipient is defined." => "No customer support request recipient is defined.",
    "No Data" => "Ma'lumotlar Yo'q",
    "no file selected" => "fayl tanlanmagan",
    "No Increase" => "Ziyoda Yo'q",
    "No payment methods on file." => "No payment methods on file.",
    "No payment scheduled." => "No payment scheduled.",
    "No Prior Data" => "Oldindan Ma'lumotlar Yo'q",
    ...
    "Pakistan" => "Pokiston",
    "Palau" => "Palau",
    "Palestinian Territory, Occupied" => "Falastin Hududlari",
    "Panama" => "Panamada",
    "Papua New Guinea" => "Papua Yangi Gvineya",
    "Paraguay" => "Ta Paragvay",
    "Password" => "Parolini",
    ...
    "Press / to search" => "Matbuot / qidirish uchun",
    ...
    "Puerto Rico" => "Puerto Olib Keldi",
    "Qatar" => "Qatar",
    "Quarter To Date" => "Bugungi Kunga Qadar Chorak",
    "Quebec" => "Quebec",
    ...
    "Restore Resource" => "Resurs Tiklash",
    "Restore Selected" => "Tanlangan Tiklash",
    "results" => "natijalar",
    "Resume" => "Resume",
    ...
    "Romania" => "Ruminiya",
    "Run Action" => "Ishlatish Harakat",
    "Russian Federation" => "Rossiya Federatsiyasi",
    "Rwanda" => "Ruanda degan",
    "Réunion" => "Réunion",
    "Saint Barthelemy" => "Sankt-Barthélemy",
    "Saint Barthélemy" => "Saint Barthélemy",
    "Saint Helena" => "Sankt-Helena",
    "Saint Kitts And Nevis" => "Sankt-Kitts va Nevis",
    "Saint Kitts and Nevis" => "Saint Kitts and Nevis",
    "Saint Lucia" => "Sankt Sit",
    "Saint Martin" => "Sankt Martin",
    "Saint Martin (French part)" => "Saint Martin (French part)",
    "Saint Pierre And Miquelon" => "Sankt-Pierre va Miquelon",
    "Saint Pierre and Miquelon" => "Saint Pierre and Miquelon",
    "Saint Vincent And Grenadines" => "St Vinsent va Grenadinlar",
    "Saint Vincent and the Grenadines" => "Saint Vincent and the Grenadines",
    "Samoa" => "Samoa",
    "San Marino" => "San-Marino",
    "Sao Tome And Principe" => "São Tomé va Príncipe",
    ...
    "Show All Fields" => "Barcha Maydonlarni Ko'rsatish",
    "Show Content" => "Tarkibni Ko'rsatish",
    ...
    "Solomon Islands" => "Sulaymon Orollari",
    "Somalia" => "Somalida",
    ...
    "Sorry! You are not authorized to perform this action." => "Kechirasiz! Siz bu harakatni amalga oshirish uchun vakolatli emas.",
    "Sorry, your session has expired." => "Kechirasiz, sessiyangiz tugadi.",
    "South Africa" => "Janubiy Afrika",
    "South Carolina" => "South Carolina",
    "South Dakota" => "South Dakota",
    "South Georgia And Sandwich Isl." => "Janubiy Gruziya va Janubiy sendvich orollari",
    "South Georgia and the South Sandwich Islands" => "South Georgia and the South Sandwich Islands",
    "South Sudan" => "Janubiy Sudan",
    "Spain" => "Ispaniya",
    "Sri Lanka" => "Shri Lanka",
    "Standalone Actions" => "Standalone Actions",
    "Start Polling" => "Saylovni Boshlash",
    "Start polling" => "Start polling",
    "State" => "State",
    "State & ZIP / Postal Code" => "State & ZIP / Postal Code",
    "State / County" => "State / County",
    "Stop Impersonating" => "Stop Impersonating",
    "Stop Polling" => "Saylovni To'xtatish",
    ...
    "Suriname" => "Suriname",
    "Svalbard And Jan Mayen" => "Svalbard va Jan Mayen",
    ...
    "The :resource was created!" => "Bu :resource yaratilgan edi!",
    "The :resource was deleted!" => "Bu :resource o'chirildi edi!",
    "The :resource was restored!" => "Bu :resource qayta tiklandi!",
    "The :resource was updated!" => "Bu :resource yangilangan edi!",
    ...
    "The file was deleted!" => "Fayl o'chirildi!",
    ...
    "The government won't let us show you what's behind these doors" => "Hukumat bizga bu eshiklar ortida nima sizga ko \" rsatish ruxsat bermaydi",
    "The HasOne relationship has already been filled." => "HasOne munosabatlar allaqachon to'lgan qilindi.",
    ...
    "There are no available options for this resource." => "Ushbu resurs uchun mavjud variantlar mavjud emas.",
    ...
    "There was a problem executing the action." => "Harakatni bajarishda muammo yuzaga keldi.",
    "There was a problem fetching the resource." => "There was a problem fetching the resource.",
    "There was a problem submitting the form." => "Shaklni topshirishda muammo yuzaga keldi.",
    ...
    "This file field is read-only." => "Ushbu fayl maydoni faqat o'qiladi.",
    ...
    "This resource no longer exists" => "Ushbu resurs endi mavjud emas",
    ...
    "United States" => "Uzbekona. Edu. Ve",
    "United States Minor Outlying Islands" => "United States Minor Outlying Islands",
    "United States Outlying Islands" => "AQSH Outlying Orollar",
    "Unknown" => "Unknown",
    "Unpaid" => "Unpaid",
    "Update" => "Yangilash",
    "Update & Continue Editing" => "Yangilash Va Tahrirlash Davom",
    "Update :resource" => "Yangilash :resource",
    "Update :resource: :title" => "Yangilash :resource: :title",
    "Update Announcement" => "Update Announcement",
    "Update attached :resource: :title" => "Yangilash :resource biriktirilgan: :title",
    ...
    "Virginia" => "Virginia",
    "Wallis And Futuna" => "Wallis va Futuna",
    ...
    "We're lost in space. The page you were trying to view does not exist." => "Kosmosda adashib qoldik. Agar ko'rish uchun harakat qilindi sahifa mavjud emas.",
    "Welcome Back!" => "Orqaga Xush Kelibsiz!",
    ...
    "Wisconsin" => "Wisconsin",
    "With Trashed" => "Trashed Bilan",
    "Write" => "Yozish",
    "Wyoming" => "Wyoming",
    "Year To Date" => "Sanaga Yil",
    "Yearly" => "Yearly",
    "yearly" => "yearly",
